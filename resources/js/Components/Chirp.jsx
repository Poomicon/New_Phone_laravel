...
dayjs.extend(relativeTime); //เพื่อจัดการเวลาให้สามารถแสดงได้ง่าย
 
export default function Chirp({ chirp }) { 
    const { auth } = usePage().props; //เพื่อแสดงข้อมูลของข้อควาผู้ใช้งานปัจจุบัน auth
 
    const [editing, setEditing] = useState(false); //ใช้บอกว่ากำลังแก้ไขข้อความอยู่หรือไม่
 
    const { data, setData, patch, clearErrors, reset, errors } = useForm({ //จัดการฟอร์มโดยเริ่มต้นค่า message เป็นข้อความของ chirp
